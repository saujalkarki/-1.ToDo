...
exports.userLogin = async (req, res) => {
  ...
  const isPasswordMatched = true; //comparehashSync
  ...
  const loginToken = "achd"; //   generate jwt
...
exports.forgotPassword = async () => {
  ...
  const OTP = 123456; //generate OTP with otp-generator

  // call the function for sending email that is in sendEmail.js
  userExist[0].otp = OTP;
